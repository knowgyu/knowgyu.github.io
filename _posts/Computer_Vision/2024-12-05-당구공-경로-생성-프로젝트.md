...
title: "당구공 경로 생성기"
author: knowgyu
description: "당구공 경로 생성기에서 개요를 중심으로 설정·구현 흐름을 기록한다."
kind: project-log
date: 2022-12-08 18:00:00 +0900
math: true
categories: [AI & CV, Computer Vision]
tags: [OpenCV, 영상 처리, PJT, Object Detection, Project]
---
...
## 코드 레포
CAM Shift와 Mean Shift 코드는 아래 저장소에서 확인할 수 있습니다.
