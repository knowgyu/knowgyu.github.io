...
author: knowgyu
description: "MLflow 학습 트래킹 및 아티팩트 저장 2의 핵심 개념과 MLflow 내용을 정리한다."
kind: technical-note
...
[Setup Components(MLflow Tracking Server)](/posts/Setup-Components(MLflow-Tracking-Server)/)
...
**단,** 기존에 구축한 MLflow Tracking Server로 로깅하도록 **환경변수를 설정**해야 합니다.
