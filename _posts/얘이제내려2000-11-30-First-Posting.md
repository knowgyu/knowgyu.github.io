...
안녕하세요.  
이 블로그는 `로봇`, `임베디드`, `AI`를 중심으로 개발 기록과 시행착오를 정리하는 공간입니다.
...
> - **참고 링크**: [블로그 글](/posts/아두이노-초음파-SLAM/)
{: .highlight}
...
> - **참고 링크**: [블로그 글](/posts/당구공-경로-생성-프로젝트/)
{: .highlight}
...
> - **참고 링크**: [블로그 글](/categories/kubeflow/)
{: .highlight}
...
> - **참고 링크**: [블로그 글](/posts/ArUco-마커를-활용한-자율주행-RC카/)
{: .highlight}
